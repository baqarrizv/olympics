    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        <label class="control-label" for="code"><?php echo $this->lang->line("Warehouse Code"); ?>
                        </label>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="controls"> <?php echo form_input('name', '', 'class="form-control" id="title" required="required"'); ?> 
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="controls"> <?php echo form_input('person_name', '', 'class="form-control" id="contactPerson" required="required"'); ?> 
                        </div>
                    </div>
                    <div class="col-md-6">
                        <label class="control-label" for="designation"><?php echo $this->lang->line("Designation"); ?>
                        </label>
                        <div class="controls"> <?php echo form_input('person_designation', '', 'class="form-control" id="designation" required="required"'); ?> 
                        </div>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        <label class="control-label" for="Email"><?php echo $this->lang->line("Person Email"); ?>
                        </label>
                        <div class="controls"> <?php echo form_input('person_email', '', 'class="form-control" required="required"'); ?> 
                        </div>
                    </div>
                    <div class="col-md-6">
                        <label class="control-label" for="phoneOrEmail"><?php echo $this->lang->line("Person Phone"); ?>
                        </label>
                        <div class="controls"> <?php echo form_input('phone', '', 'class="form-control" id="phone" required="required"'); ?> 
                        </div>
                    </div>
