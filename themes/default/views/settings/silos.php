<script>
    $(document).ready(function () {
        ...
        $('#CURData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/getAllSilos') ?>',
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                       <li><a href="<?php echo site_url('system_settings/add_silos'); ?>" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> <?= lang('add_silos') ?></a></li>
            ...
            <div class="table-responsive">
                    <table id="CURData" class="table table-bordered table-hover table-striped table-condensed">
                        ...
                        <tr>
                            ...
                            <th><?php echo $this->lang->line("Silos Code"); ?></th>
                            <th><?php echo $this->lang->line("Silos Name"); ?></th>
                            <th><?php echo $this->lang->line("UOM"); ?></th>
