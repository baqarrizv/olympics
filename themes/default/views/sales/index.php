...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart"></i><?=lang('Release') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')';?>
               <!--  <a href="../report.php" id="" data-action="">asd</a> -->
        </h2>
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <a data-toggle="" class="" href="../report.php">
                        <i class="icon fa fa-download tip" data-placement="left" title="Download Sales Report"></i>
                    </a>
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <li>
                         ...
                         <li>
                            <a href="sales/report.php" id="combine" data-action="combine">
                                <i class="fa fa-file-pdf-o"></i> All Data
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                ...
                <?php if (!empty($warehouses)) {
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?=site_url('sales')?>"><i class="fa fa-build\ing-o"></i> <?=lang('all_warehouses')?></a></li>
                            <li class="divider"></li>
                            <?php
