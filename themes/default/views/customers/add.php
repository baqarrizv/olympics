        ...
        <div class="modal-body">
            ...
            <div class="row"> 
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <?= lang("GST No", "gst"); ?>
                        <?php echo form_input('gst', '', 'class="form-control" id="gst" required="required"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang("Credit Limit", "credit_limit"); ?>
                        <?php echo form_input('credit_limit', '', 'class="form-control" id="credit_limit" required="required"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang("General Note", "general_note"); ?>
                        <?php echo form_input('general_note', '', 'class="form-control" id="general_note" required="required"'); ?>
                    </div>
                </div>
            </div>
