            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <?= lang("GST No", "gst"); ?>
                        <?php echo form_input('gst', '', 'class="form-control" id="gst"'); ?>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <?= lang("Mailing Address", "mailing_address"); ?>
                        <?php echo form_input('mailing_address', '', 'class="form-control" id="mailing_address"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang("Credit Limit", "credit_limit"); ?>
                        <?php echo form_input('credit_limit', '', 'class="form-control" id="credit_limit"'); ?>
                    </div>
                    <div class="form-group">
                        <label class="control-label"
                               for="payment_term"><?php echo $this->lang->line("Payment_term"); ?></label>

                        <div class="controls"> <?php
                            foreach ($payment_terms as $payment_term) {
                                $pt[$payment_term->terms_indicator] = $payment_term->terms;
                            }
                            echo form_dropdown('payment_term', $pt, $this->Settings->payment_term, 'class="form-control tip select" id="payment_term" style="width:100%;" required="required"');
                            ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <?= lang("General Note", "general_note"); ?>
                        <?php echo form_input('general_note', '', 'class="form-control" id="general_note"'); ?>
                    </div>
                </div>
            </div>
