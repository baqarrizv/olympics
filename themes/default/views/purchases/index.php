                    ...
                    <table id="POData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="active">
                           <!--  <th style="min-width:30px; width: 30px; text-align: center;">
                            ...
                            <th><?php echo $this->lang->line("NAT Volume"); ?></th>
                            <th><?php echo $this->lang->line("Volume at 85F"); ?></th>
                            <th><?php echo $this->lang->line("Waste QTY"); ?></th>
                            <th><?php echo $this->lang->line("Warehouse"); ?></th>
                            <th><?php echo $this->lang->line("Reservoir/Tank"); ?></th>
                            <th style="width:100px;"><?php echo $this->lang->line("actions"); ?></th>
                        </tr>
                        </thead>
                        <tbody>
