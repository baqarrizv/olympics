...
class Reports extends MY_Controller
{
    ...
    function stock()
    {
        ...
        $bc = array(array('link' => base_url(), 'page' => lang('home')), array('link' => site_url('Reports'), 'page' => lang('Reports')), array('link' => '#', 'page' => lang('Stock Report')));
        $meta = array('page_title' => lang('Stock Report'), 'bc' => $bc);
    ...
    public function product_ledger()
    {
        ...
        $bc = array(array('link' => base_url(), 'page' => lang('home')), array('link' => '#', 'page' => lang('reports')));
        $meta = array('page_title' => lang('Product Ledger'), 'bc' => $bc);
        $this->page_construct('reports/product_ledger', $meta, $this->data);
    }
    ...
    public function get_product_ledger($id)
    {
        ...
        $this->load->model('Products_model', 'products_model');
        echo json_encode($this->products_model->getProductLedger($id));
    }
    ...
    public function waste()
    {
        ...
        $this->data['error'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('error');
        $this->data['waste'] = $this->site->getWasteData();


        $bc = array(array('link' => base_url(), 'page' => lang('home')), array('link' => site_url('reports'), 'page' => lang('reports')), array('link' => '#', 'page' => lang('Waste Report')));
        $meta = array('page_title' => lang('Waste Report'), 'bc' => $bc);
        $this->page_construct('reports/waste', $meta, $this->data);
    }
    ...
    function purchases()
    {
        ...
        $this->data['error'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('error');
        $this->data['purchases'] = $this->reports_model->getPurchases();
