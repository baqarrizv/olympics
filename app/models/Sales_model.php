...
class Sales_model extends CI_Model
{
    ...
    public function update_sales_order_version($order_no, $version)
    {
        $sql= 'UPDATE sma_fin_sales_orders SET version=version+1 WHERE order_no='.$order_no.
        ' AND version='.$version . " AND trans_type= 30";
        return $this->db->query($sql);
