...
class system_settings extends MY_Controller
{
    ...
    function getWarehouses()
    {
        $this->load->library('datatables');
        $this->datatables
            ->select("fin_locations.loc_code, fin_locations.location_name, fin_locations.phone, fin_locations.email, fin_locations.delivery_address, ws.location_name as parent")
            ->from("fin_locations")
            //->where("parent_id", '0')
